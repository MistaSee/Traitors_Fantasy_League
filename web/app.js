...
let api, data, tab='Standings', episode=2, kind=null, selected=[], captain='', scoredCharacter=seed.characters[0]?.id||'', saving=false, navigating=false;
